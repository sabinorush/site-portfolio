export const projects = [
  ...
  },
  {
    ...
    stack: ['TypeScript', 'NestJS', 'Clean Architecture'],
  ...
  },
  {
    ...
    stack: ['TypeScript', 'Node.js', 'SOLID'],
    link: 'https://github.com/sabinorush/3-api-solid',
  },
]

export const hardSkills = [
  'JavaScript', 'TypeScript', 'Node.js', 'NestJS', 'React.js', 'Next.js',
  'PostgreSQL', 'MySQL', 'Docker', 'Vite', 'Git', 'API RESTful',
  'SOLID', 'Clean Code', 'DDD', 'MVC', 'SCRUM',
]

export const softSkills = [
  { pt: 'Aprendizado contínuo (Self-learner)', en: 'Continuous learning (Self-learner)' },
  { pt: 'Comunicação clara e objetiva', en: 'Clear and objective communication' },
  { pt: 'Trabalho em equipe', en: 'Teamwork' },
  { pt: 'Organização e proatividade', en: 'Organization and proactivity' },
  { pt: 'Metodologias Ágeis (Scrum, TDD)', en: 'Agile Methodologies (Scrum, TDD)' },
]
